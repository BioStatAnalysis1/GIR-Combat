...
for (mdx in seq_len(nmerges)) {
                                ...
                                k, prop.k = NULL, ...) 
  {
    ...
    findMutualNN <- function (data1, data2, k1, k2 = k1, BNINDEX1 = NULL, BNINDEX2 = NULL) 
    {
      ...
      #   args$X <- data2
      # }
      #********      W21 <- queryKNN(data2, query=data1, k=k2, get.distance=FALSE) # W21 <- do.call(queryKNN, args)
      ...
      #   args$X <- data1
      # }
      #********            W12 <- queryKNN(data1, query=data2, k=k1, get.distance=FALSE) # W12 <- do.call(queryKNN, args)
